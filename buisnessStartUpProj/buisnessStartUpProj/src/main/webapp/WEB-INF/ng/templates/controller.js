...
angular.module("FishTank").controller("indProjCtrl", function($state, $http, BaseService, SearchService, $scope, $uibModal, $log){
	...
	function star1click(){ipc.lock = 1;ipc.newReviewStars=1;console.log("ipc.lock = "+ipc.lock);}
	function star2click(){ipc.lock = 2;ipc.newReviewStars=2;console.log("ipc.lock = "+ipc.lock);}
	function star3click(){ipc.lock = 3;ipc.newReviewStars=3;console.log("ipc.lock = "+ipc.lock);}
	function star4click(){ipc.lock = 4;ipc.newReviewStars=4;console.log("ipc.lock = "+ipc.lock);}
	function star5click(){ipc.lock = 5;ipc.newReviewStars=5;console.log("ipc.lock = "+ipc.lock);}
